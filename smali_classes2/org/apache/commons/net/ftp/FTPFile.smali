...
.method public toFormattedString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    const-string v4, " %1$tY-%1$tm-%1$td"
    ...
    .line 484
    invoke-virtual {p1, v4}, Ljava/util/Calendar;->isSet(I)Z

    move-result v4

    if-eqz v4, :cond_3

    const-string v4, " %1$tH"
