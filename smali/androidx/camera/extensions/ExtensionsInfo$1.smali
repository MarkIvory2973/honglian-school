...
.method public synthetic getSupportedCaptureResultKeys()Ljava/util/List;
    .locals 1

    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$getSupportedCaptureResultKeys(Landroidx/camera/extensions/internal/VendorExtender;)Ljava/util/List;
...
.method public synthetic getSupportedPostviewResolutions(Landroid/util/Size;)Ljava/util/Map;
    .locals 0

    invoke-static {p0, p1}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$getSupportedPostviewResolutions(Landroidx/camera/extensions/internal/VendorExtender;Landroid/util/Size;)Ljava/util/Map;
...
.method public synthetic isCaptureProcessProgressAvailable()Z
    .locals 1

    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$isCaptureProcessProgressAvailable(Landroidx/camera/extensions/internal/VendorExtender;)Z
...
.method public synthetic isCurrentExtensionModeAvailable()Z
    ...
    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$isCurrentExtensionModeAvailable(Landroidx/camera/extensions/internal/VendorExtender;)Z
...
.method public synthetic isExtensionStrengthAvailable()Z
    ...
    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$isExtensionStrengthAvailable(Landroidx/camera/extensions/internal/VendorExtender;)Z
...
.method public synthetic isPostviewAvailable()Z
    .locals 1

    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$isPostviewAvailable(Landroidx/camera/extensions/internal/VendorExtender;)Z
...
.method public synthetic willReceiveOnCaptureCompleted()Z
    .locals 1

    invoke-static {p0}, Landroidx/camera/extensions/internal/VendorExtender$-CC;->$default$willReceiveOnCaptureCompleted(Landroidx/camera/extensions/internal/VendorExtender;)Z
